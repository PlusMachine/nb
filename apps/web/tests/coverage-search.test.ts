...
vi.mock("@nb/db", () => {
  ...
  const schemaExports = [
    ...
    "ingredientCatalogItems", "ingredientCatalogItemsRelations", "ingredientCategoryEnum",
    "ingredientCompletenessLevelEnum", "ingredientFamilies", "ingredientFamiliesRelations",
