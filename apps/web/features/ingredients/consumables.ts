...
const consumableUsageStageLabels: Record<string, string> = {
  ...
  dispense: "Подача",
  equipment_cleaning: "Мойка оборудования",
  fermentation: "Брожение",
  fermentation_start: "Начало брожения",
  filtration: "Фильтрация",
  finished_beer: "Готовое пиво",
  flameout: "Вирпул",
  low_oxygen_process: "Низкокислородная варка",
  mash: "Затор",
  other: "Другое",
  packaging: "Розлив",
  post_fermentation: "После брожения",
  pre_clean: "Замачивание",
  pre_packaging: "Перед розливом",
  primary: "Брожение",
