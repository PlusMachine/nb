...
|---|---|---|---|---|---|---|
| OG | 37 | 7.0 пт | 37.0 пт | 11.3% | 61.7% | +4.9 пт |
| FG | 37 | 3.8 пт | 15.0 пт | 36.1% | 350.0% | +1.8 пт |
| ABV | 37 | 0.9 | 4.4 | 13.2% | 72.1% | +0.3 |
| IBU | 37 | 13.1 | 109.4 | 30.5% | 109.4% | -5.2 |
...
- **FG:** Stone Ruination IPA (ист. 12.0 пт → расч. 27.0 пт, Δ15.0 пт); Saison Dupont в стиле (Paul Zocco) (ист. 4.0 пт → расч. 18.0 пт, Δ14.0 пт); Stone IPA (ист. 12.0 пт → расч. 23.0 пт, Δ11.0 пт)
- **ABV:** Märzen / Oktoberfest (Gordon Strong) (ист. 6.1 → расч. 10.5, Δ4.4); Motor Oil RIS (ист. 8.3 → расч. 12.2, Δ3.9); Westvleteren 12 (клон «The Pious») (ист. 11.2 → расч. 8.1, Δ3.1)
- **IBU:** Pliny the Elder (клон Russian River) (ист. 100.0 → расч. 209.4, Δ109.4); Motor Oil RIS (ист. 82.0 → расч. 37.0, Δ45.0); North Coast Old Rasputin (ист. 75.0 → расч. 39.5, Δ35.5)
